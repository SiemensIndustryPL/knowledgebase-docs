    ...
    [UCZYSZ SIĘ? 2](#_Toc57888541)

    [1\. SIMATIC S7-1200 + SINAMICS V90 PTI. 3](#_Toc57888542)

    [1.1 Sterowanie impulsowe 3](#_Toc57888543)

    [1.2 Sterowanie sygnałem analogowym 10](#_Toc57888544)

    [1.3 Pozycjoner napędu (IPOS) 12](#_Toc57888545)

    [2\. SIMATIC S7-1500 + SINAMICS V90 PN 16](#_Toc57888546)

    [2.1 Sterowanie prędkością - Telegram 1 16](#_Toc57888547)

    [2.2 Pozycjonowanie - Telegram 3 21](#_Toc57888548)

    [2.3 Pozycjoner napędu (EPOS) - Telegram 111 23](#_Toc57888549)

    [3\. S7-1500(T) + SINAMICS S210. 26](#_Toc57888550)

    [3.1 Pozycjonowanie – SIEMENS Telegram 105 (IRT) 27](#_Toc57888551)

    [3.2 Synchronizm liniowy. 33](#_Toc57888552)

    [3.3 Sprzężenie krzywkowe 36](#_Toc57888553)

    [3.4 Układ kinematyczny 39](#_Toc57888554)

    [3.5 Enkoder zewnętrzny 43](#_Toc57888555)

    [3.6 Wejście pomiarowe 45](#_Toc57888556)

    [3.7 Wyjście krzywkowe 48](#_Toc57888557)

    [3.8 Komunikacja acykliczna 50](#_Toc57888558)

    [3.9 Ograniczenie siły 52](#_Toc57888559)

    ## UCZYSZ SIĘ?

    Przyjmuję, że wstęp teoretyczny masz już za sobą i oczekujesz teraz możliwości sprawdzenia nabytej wiedzy w praktyce. Właśnie tak będzie – w ostatnim rozdziale mam zamiar zaproponować Ci zestaw ćwiczeń oraz doświadczeń, które możesz przeprowadzić samodzielnie w warunkach domowych aplikując sporą część poznanych przez Ciebie zagadnień _Motion Control._ Dzięki możliwościom środowiska inżynierskiego TIA Portal – wiele mechanizmów można nie tylko zasymulować i uruchomić ale także obserwować i diagnozować ich przebieg.

    Jeśli posiadasz stanowisko testowe ze sterownikiem oraz układem napędowym, z pewnością będziesz w stanie wykonać więcej ciekawych ćwiczeń. Brak sprzętu nie jest jednak przeszkodą w implementacji przynajmniej części zaproponowanych zadań.

    Mam również nadzieję, że udało mi się wzbudzić Twoją ciekawość opisanymi wspólnie z firmami partnerskimi projektami, które są namacalnym dowodem zastosowania omawianej problematyki _Motion Control_ w polskim przemyśle. Przykłady, które poddasz analizie w tej - praktycznej - części publikacji, mają swoje źródło w moich doświadczeniach aplikacyjnych. Tematykę rozdziału dobrałem zgodnie z problemami na jakie natknąłem się podczas pracy inżynierskiej, a także z jakimi zgłaszają się do mnie najczęściej programiści oraz użytkownicy systemów sterowania ruchem SIMATIC.

    Liczę, iż dobór zagadnień pokrywa się z Twoimi zainteresowaniami. Zestaw ćwiczeń ułożyłem w sposób zachęcający do wnikliwego zagłębienia się w arkana stosowanych w przemyśle mechanizmów sterownia ruchem. Metodyka „krok po kroku” ułatwia pełne okiełznanie kwestii przedstawionych zarówno w części teoretycznej jak i praktycznej niniejszej publikacji. Forma, którą przyjąłem zawiera zestaw wskazówek, które – mam nadzieję – zachęcą Cię do samodzielnego zmierzenia się z zaproponowanymi zagadnieniami.
    ...
    **Przykład.** Wartość wygenerowana w przykładowym programie na wyjście analogowe (11849) stanowi ok 43% wartości maksymalnej (27648). W związku z powyższym na wyjściu fizycznym generowane jest napięcie ok 4.3V, co z kolei przy naszej konfiguracji będzie oznaczało 43% wartości maksymalnej(znamionowej) prędkości zdefiniowanej w kroku poprzednim.
    ...
    1.  SIMATIC S7-1500 + SINAMICS V90 PN
